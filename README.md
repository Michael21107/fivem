...
## License
FiveM is licensed under a dual license, details of which are in the [LICENSE](https://github.com/citizenfx/fivem/blob/master/LICENSE) file in the repository.
